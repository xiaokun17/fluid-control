	...
	*/
	...
	public:
		...
		struct ControlData
		{
			...
			//Real density;
			//bool dynamic;
			bool isWall;//isRender 20200924-zj
			Eigen::Vector4f color;
			//void* ControlBody;
		};
		...
		struct Scene
		{
			...
			std::vector<ControlData*> controlModels;//control 20200924-zj
			std::vector<ControlData*> targetModels;
